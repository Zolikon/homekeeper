...
import { MdAdd, MdDelete, MdOpenInNew, MdPets, MdRemove } from "react-icons/md";
...
export default function ZooplusItemDisplay({ item }: { item: ZooplusItem }) {
  ...
  return (
    <div
      className={`flex items-center justify-between gap-2 rounded-lg p-2 w-[80%] md:w-[40%] my-2 ${amount > 0 && "bg-green-500 text-black"
